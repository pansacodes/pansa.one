...
function changeText() {
    ...
    callElement("subheading").innerHTML += " I enjoy creating things that live on the internet websites apps & anything in between. I've managed to gain a decent amount of experience and valuable knowledge from different kinds of projects. I'm fueled by coffee & driven by the lyrical magic of music";
}
function copyText() {
